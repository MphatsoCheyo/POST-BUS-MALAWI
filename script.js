...
function logout() {
    ...
    if (confirm('Are you sure you want to logout?')) {
        ...
        window.location.href = 'splash.php'; // Assuming your splash screen is index.php
    }
}
...
document.addEventListener('click', function(event) {
    ...
    if (!navDrawer.contains(event.target) && !hamburger.contains(event.target) && navDrawer.classList.contains('open')) {
