...
<head>
    ...
    <title>Profile & Loyalty App</title>
    ...
    <style>
        * {
        ...
        :root {
            ...
            --silver-color: #b2bec3;
            --gold-color: #f1c40f;
            --platinum-color: #81ecec;
            --diamond-color: #74b9ff;
        }
    ...
    <div class="app-container">
        ...
        <div class="bottom-nav">
            ...
            <div class="bottom-nav-item">
                <div class="bottom-nav-icon"><i class="fas fa-shopping-bag"></i></div>
                <div class="bottom-nav-label">Shop</div>
            </div>
            <div class="bottom-nav-item">
                <div class="bottom-nav-icon"><i class="fas fa-heart"></i></div>
        ...
        <footer class="app-footer">
            <p>© 2025 Profile & Loyalty App. All rights reserved.</p>
        </footer>
    </div>
